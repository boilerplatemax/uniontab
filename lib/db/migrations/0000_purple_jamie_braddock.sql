...
CREATE TABLE "file_categories" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "file_categories_union_id_name_unique" UNIQUE("union_id","name")
);
--> statement-breakpoint
CREATE TABLE "files" (
	"id" serial PRIMARY KEY NOT NULL,
...
CREATE TABLE "members" (
	...
	CONSTRAINT "idx_members_unique_user_union" UNIQUE("union_id","user_id")
);
--> statement-breakpoint
...
ALTER TABLE "announcements" ADD CONSTRAINT "announcements_union_id_unions_id_fk" FOREIGN KEY ("union_id") REFERENCES "public"."unions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "dismissed_announcements" ADD CONSTRAINT "dismissed_announcements_announcement_id_announcements_id_fk" FOREIGN KEY ("announcement_id") REFERENCES "public"."announcements"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "dismissed_announcements" ADD CONSTRAINT "dismissed_announcements_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "file_categories" ADD CONSTRAINT "file_categories_union_id_unions_id_fk" FOREIGN KEY ("union_id") REFERENCES "public"."unions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
